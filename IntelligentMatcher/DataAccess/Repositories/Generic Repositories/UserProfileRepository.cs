...
namespace DataAccess.Repositories
{
    public class UserProfileRepository : IUserProfileRepository
    {
        ...
        {
            var query = "select [Id], [FirstName], [Surname], [UserAccountId] from [UserProfile]";
        ...
        {
            var query = "select [Id], [FirstName], [Surname], [UserAccountId]" +
        ...
        {
            var query = "select [Id], [FirstName], [Surname]" +
