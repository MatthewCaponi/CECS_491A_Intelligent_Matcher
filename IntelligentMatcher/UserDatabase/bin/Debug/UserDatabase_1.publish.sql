...
:setvar DefaultDataPath "C:\Users\shari\AppData\Local\Microsoft\Microsoft SQL Server Local DB\Instances\mssqllocaldb\"
:setvar DefaultLogPath "C:\Users\shari\AppData\Local\Microsoft\Microsoft SQL Server Local DB\Instances\mssqllocaldb\"
...
GO
PRINT N'Creating [dbo].[SecurityQuestions]...';
...
CREATE TABLE [dbo].[UserAccount] (
    ...
    PRIMARY KEY CLUSTERED ([Id] ASC),
    CONSTRAINT [CK_UserAccount_EmailAddress] UNIQUE NONCLUSTERED ([EmailAddress] ASC),
    CONSTRAINT [CK_UserAccount_Username] UNIQUE NONCLUSTERED ([Username] ASC)
);
...
GO
PRINT N'Creating [dbo].[FK_SecurityQuestions_UserAccount]...';


GO
ALTER TABLE [dbo].[SecurityQuestions]
    ADD CONSTRAINT [FK_SecurityQuestions_UserAccount] FOREIGN KEY ([UserAccountId]) REFERENCES [dbo].[UserAccount] ([Id]);
...
END
GO
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'da04586b-1d05-44a4-bfdb-376b72d4af31')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('da04586b-1d05-44a4-bfdb-376b72d4af31')
