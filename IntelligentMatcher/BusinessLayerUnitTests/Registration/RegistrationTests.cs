...
namespace BusinessLayerUnitTests.Registration
{
    ...
    public class RegistrationTests
    {
        ...
        {
            //Arrange
            //Mock<EmailVerificationService> mockEmailVerificationService = new Mock<EmailVerificationService>();
            EmailVerificationService emailVerificationService = new EmailVerificationService();
            //Mock<UserAccountService> mockUserAccountService = new Mock<UserAccountService>();
            ...
            //Mock<UserProfileService> mockUserProfileService = new Mock<UserProfileService>();
            UserProfileService userProfileService = new UserProfileService(new UserProfileRepository
                (new DataGateway(), new ConnectionStringData()));
            //Mock<ValidationService> mockValidationService = new Mock<ValidationService>();
        ...
        public async Task RegisterUser_LessThan5Seconds(int expectedId, string username, string password,
            string emailAddress, string accountType, string accountStatus, string creationDate, string updationDate,
            string firstName, string lastName, int expectedTime)
        {
            //Arrange
            EmailVerificationService emailVerificationService = new EmailVerificationService();
            UserAccountService userAccountService = new UserAccountService(new UserAccountRepository
            ...
            var actualResult = await registrationManager.RegisterNewAccount(webUserAccountModel, 
                webUserProfileModel, false, password);
            timer.Stop();
